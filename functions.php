<?php
	...
	require_once get_stylesheet_directory() . '/oxfam-settings.php';
	...
	// @toDo: Kan in principe vervangen worden door core functionaliteit WooMultistore
	...
	function load_child_theme() {
		wp_enqueue_style( 'oxfam-webshop', get_stylesheet_uri(), array( 'nm-core' ), '2.1.5' );
