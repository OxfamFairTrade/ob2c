    ...
    */	
	...
	function sample_admin_notice() {
		...
		if ( $pagenow === 'index.php' and $screen->base === 'dashboard' ) {
			...
			// echo '</div>';
			echo '<div class="notice notice-error">';
			echo '<p>Volg <a href="https://github.com/OxfamFairTrade/ob2c/wiki/Betaling#hoe-activeer-ik-mijn-account-bij-mollie" target="_blank">de handleiding</a> om de activering van je Mollie-account te voltooien. Het duurt enkele dagen vooraleer je overschrijving met de gestructureerde mededeling verwerkt is.</p>';
