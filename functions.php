	...
	function oxfam_admin_notices() {
		...
		if ( $pagenow === 'index.php' and $screen->base === 'dashboard' ) {
			...
			echo '<div class="notice notice-info">';
				echo '<p>Sinds begin deze maand vinden jullie - zoals lang geleden gevraagd - in bijlage bij elke nieuwe bestelmail een Excel-file op printvriendelijk formaat. Indien gewenst kun je dit klaarleggen of doorsturen zodat een winkelier de bestelling kan klaarzetten. Bovenaan staat vermeld of het om een afhaling of thuislevering gaat. In de laatste kolom is ruimte voorzien om te noteren hoeveel stuks effectief geleverd werden. Het bestand kan ook gedownload worden via <a href="edit.php?post_type=shop_order">het WooCommerce-overzichtsscherm</a> in de back-end van de webshop.</p>';
