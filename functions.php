<?php
	...
	function load_child_theme() {
		wp_enqueue_style( 'oxfam-webshop', get_stylesheet_uri(), array( 'nm-core' ), '2.1.3' );
	...
	function oxfam_admin_notices() {
		...
		if ( 'index.php' === $pagenow and 'dashboard' === $screen->base ) {
			...
			if ( get_current_site()->domain === 'shop.oxfamwereldwinkels.be' ) {
				...
				// echo '<div class="notice notice-success">';
				// 	echo '<p>De resterende aprilmagazineproducten en de nieuwe Doppers werden toegevoegd aan de database:</p><ul style="margin-left: 2em; column-count: 2;">';
