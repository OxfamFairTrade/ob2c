<?php
	...
	function custom_oxfam_options() {
		...
		add_menu_page( 'Stel de voorraad van je lokale webshop in', 'Voorraadbeheer', 'administrator', 'oxfam-product-list', 'oxfam_products_list_callback', 'dashicons-admin-settings', '57' );
