    ...
    */	
	...
	function sample_admin_notice() {
		...
		if ( $pagenow === 'index.php' ) {
			...
			echo '<p>De mailing geraakt vrijdag niet meer de deur uit maar komt er tegen vanavond aan! Bekijk alvast <a href="http://www.gemeentekaart.be/#6d86cbca-8d77-43c3-8cb5-3c3fa09a6ca6" target="_blank">de bijgewerkte postcodekaart</a>.</p>';
			echo '</div>';
			echo '<div class="notice notice-info">';
