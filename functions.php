    ...
    */	
	...
	function sample_admin_notice() {
		...
		if ( $pagenow === 'index.php' and $screen->base === 'dashboard' ) {
			...
			// echo '</div>';
			echo '<div class="notice notice-error">';
			echo '<p>Volg <a href="https://github.com/OxfamFairTrade/ob2c/wiki/Betaling#hoe-activeer-ik-mijn-account-bij-mollie" target="_blank">de handleiding</a> om de activering van je Mollie-account te voltooien. Het duurt enkele dagen vooraleer je overschrijving met de gestructureerde mededeling verwerkt is. (Door een onaangekondigde wijziging in de datastructuur van Mollie bleef de waarschuwing over een niet-geverifieerd rekeningnummer ook verschijnen indien de verificatie toch al succesvol afgerond was, maar dat is inmiddels opgelost.)</p>';
			echo '<p>De activatie van kredietkaarten als betaalmethode is voor elke webshop reeds aangevraagd maar kan pas afgerond worden nadat de webshop gepubliceerd is. Een onderdeel van dat activatieproces is immers een controle van de aangeboden producten. Bij alcoholische producten moeten we nog een boodschap toevoegen dat verkoop enkel toegestaan is aan meerderjarigen. In afwachting mag je de rode waarschuwing op de \'<a href="admin.php?page=oxfam-options">Winkelgegevens</a>\'-pagina negeren.</p>';
			echo '<p>Sommige winkels kregen een bericht dat hun legitimatiebewijs afgewezen werd. Dit blijkt het geval te zijn indien de rechtsgeldige vertegenwoordiger die we opgaven (= de persoon waarvan jullie ons de identiteitskaart bezorgden) nog niet in de digitale versie van het KBO geregistreerd staat. We adviseren in dat geval om de rechtsgeldige vertegenwoordiger aan te passen naar iemand die wel reeds vermeld staat in het KBO. (Volg de link naast het BTW-nummer op de \'<a href="admin.php?page=oxfam-options">Winkelgegevens</a>\'-pagina.)</p>';
			echo '</div>';
