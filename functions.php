	...
	*/	
	...
	function oxfam_admin_notices() {
		...
		if ( 'index.php' === $pagenow and 'dashboard' === $screen->base ) {
			...
			if ( get_current_site()->domain === 'shop.oxfamwereldwinkels.be' ) {
				echo '<div class="notice notice-warning">';
					echo '<p>De <a href="https://copain.oww.be/k/n1074/news/view/20167/20871/promo-s-online-winkel-september-2021-update.html" target="_blank">promo\'s voor september</a> zijn geactiveerd in alle webshops. Door problemen met de server verliep de update vandaag erg moeizaam en waren de promoties pas vanaf 18 uur actief. Onze excuses voor het ongemak.</p>';
				echo '</div>';
