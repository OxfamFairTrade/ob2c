<?php
	...
	function custom_oxfam_options() {
		add_menu_page( 'Stel de voorraad van je lokale webshop in', 'Voorraadbeheer', 'manage_woocommerce', 'oxfam-products-list', 'oxfam_products_photos_callback', 'dashicons-admin-settings', '56' );
		add_submenu_page( 'oxfam-products-list', 'Stel de voorraad van je lokale webshop in', 'Lijstweergave', 'manage_woocommerce', 'oxfam-products-list', 'oxfam_products_list_callback' );
		add_submenu_page( 'oxfam-products-list', 'Stel de voorraad van je lokale webshop in', 'Fotoweergave', 'manage_woocommerce', 'oxfam-products-photos', 'oxfam_products_photos_callback' );
    ...
    */	
	...
	function dashboard_pilot_news_widget_function() {
		...
		echo "<p>De eerste ruwe versie van de <a href='https://github.com/OxfamFairTrade/ob2c/wiki' target='_blank'>online FAQ voor webshopbeheerders</a> staat online. Hierin verzamelen we alle mogelijke vragen die jullie als lokale webshopbeheerders kunnen hebben en beantwoorden we ze punt per punt met tekst en screenshots. Daarnaast kun je nog altijd <a href='https://demo.oxfamwereldwinkels.be/wp-content/uploads/slides-1ste-opleiding-B2C-webshop.pdf' target='_blank'>de slides van de 1ste opleidingssessie</a> raadplegen voor een overzicht van alle afspraken.</p>";
		echo "<p>Vanaf 13 juni kun je als deelnemende winkel een mail verwachten met alle toegangsgegevens voor jullie persoonlijke webshop (mailbox, website, Mollie en eventueel SendCloud). Enkel de portaalpagina en de FAQ voor klanten vergt nog wat werk. Vanaf 19 juni zetten de webshops publiek, tenzij jullie nog wat meer tijd nodig hebben. Geef een seintje via <a href='mailto:e-commerce@oft.be'>e-commerce@oft.be</a>.</p>";
		echo "<p>Dit zijn <a href='https://demo.oxfamwereldwinkels.be/wp-content/uploads/slides-2de-opleiding-B2C-webshop.pdf' target='_blank'>de slides van de 2de opleidingssessie</a>. Voor onderling overleg (en met ons) kun je vanaf nu ook terecht op <a href='https://oxfamfairtrade.slack.com' target='_blank'>Slack</a>. Iedere webshopvrijwilliger kreeg hiervoor op 22/05/2017 een uitnodigingsmail. Dit is optioneel, alle belangwekkende documenten blijven we op dit dashboard en op <a href='http://extranet.oxfamwereldwinkels.be/webshop target='_blank'>Extranet</a> plaatsen. Voor dringende problemen bel je vanaf 1 juli gewoon naar de Klantendienst, die een opleiding krijgt om jullie bij te staan bij het beheer.</p>";
		echo "</div>";
