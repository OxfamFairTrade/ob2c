...
?>
	...
	<div class="nm-header-logo">
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
			...
			<?php if ( ! is_main_site() ) : ?>
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/oww-webshop-groen-60px@2x.png" class="nm-logo" alt="Logo van Oxfam-Wereldwinkels">
				<?php if ( $has_alt_logo ) : ?>
			...
			<?php else : ?>
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/oww-webshop-zwart-60px@2x.png" class="nm-logo" alt="Logo van Oxfam-Wereldwinkels">
