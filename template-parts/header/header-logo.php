...
<div class="nm-header-logo">
	<a href="<?php echo esc_url( home_url('/') ); ?>">
		...
		<?php if ( ! is_main_site() ) : ?>
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo-green.svg" class="nm-logo" alt="<?php bloginfo('name'); ?>">
			<?php if ( $alt_logo_url ) : ?>
		...
		<?php else : ?>
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo-black.svg" class="nm-logo" alt="<?php bloginfo('name'); ?>">
