...
<?php
    // GEWIJZIGD: Custom banner met afhaal/leverinfo (en postcodezoeker op portaal)
    if ( is_main_site() ) {
        echo '<div class="general-store-notice"><p class="free-shipping">Nu met <b><u>gratis</u></b> verzending vanaf 50 euro!</p></div>';
        echo print_store_selector();
    } else {
