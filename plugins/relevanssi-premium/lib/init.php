...
function relevanssi_menu() {
	...
	add_dashboard_page(
		...
		__('User searches', 'relevanssi'),
		// GEWIJZIGD: Verander capability van 'edit_pages' naar 'manage_woocommerce' zodat ook lokale beheerders de logs kunnen bekijken
		apply_filters('relevanssi_user_searches_capability', 'manage_woocommerce'),
		$relevanssi_variables['file'],
