	...
	class WC_Admin_Dashboard {
		...
		public function __construct() {
			...
			if ( current_user_can( 'view_woocommerce_reports' ) || current_user_can( 'manage_woocommerce' ) || current_user_can( 'publish_shop_orders' ) ) {
				...
				if ( is_multisite() && is_network_admin() ) {
					// GEWIJZIGD: Verwijderen, veroorzaakt EP-fouten door tientallen gelijktijdige API-calls
		...
		private function status_widget_order_rows() {
			...
			foreach ( wc_get_order_types( 'order-count' ) as $type ) {
				...
				// GEWIJZIGD: Vervang 'on-hold' door interessantere status bij regiowerkingen
