...
// Target and initialize all read more elements
const ReadSmore = window.readSmore
const readMores = document.querySelectorAll('.woocommerce-product-details__short-description')
const readMoreOptions = {
  moreText: 'Lees meer',
  lessText: 'Lees minder',
  charsCount: 200
}
ReadSmore(readMores, readMoreOptions).init()