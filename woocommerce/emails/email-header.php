				...
				<tr>
					<td align="center" valign="top">
						...
						<?php
							...
							echo '<p style="margin-top:0;"><a href="' . esc_url( get_site_url() ) . '" title="Naar de webshop" target="_blank"><img src="' . esc_url( $img ) . '" style="max-width: 300px;" alt="' . get_bloginfo( 'name', 'display' ) . '" /></a></p>';
						?>
						</div>
