						...
						<?php
							...
							if ( $email_heading !== __( 'Hoera, een nieuwe bestelling!', 'oxfam-webshop' ) ) {
								...
								if ( $img = do_shortcode( get_option( 'woocommerce_email_header_image' ) ) ) {
									echo '<p style="margin-top:0;"><a href="'.home_url().'" title="Naar de webshop" target="_blank"><img src="' . esc_url( $img ) . '" style="max-width: 250px;" alt="' . get_bloginfo( 'name', 'display' ) . '" /></a></p>';
								}
								echo '</div>';
							}
						?>
