					...
					<td align="center" valign="top">
						<div id="template_header_image">
							<?php
								...
								echo '<a href="' . esc_url( get_site_url() ) . '" style="margin-left: 40px; padding-bottom: 10px;" title="Naar de webshop" target="_blank"><img src="' . esc_url( $img ) . '" alt="' . get_bloginfo( 'name', 'display' ) . '" /></a>';
							?>
						</div>
