...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<?php printf( '<a href="#" class="shipping-calculator-button">%s</a>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Liever thuislevering? Vul je postcode in.', 'oxfam-webshop' ) ) ); ?>
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<!-- GEWIJZIGD: Na postcode plaatsen -->
		...
		<!-- GEWIJZIGD: Tekst aanpassen -->
		<p><button type="submit" name="calc_shipping" value="1" class="button"><?php esc_html_e( 'Bereken verzendkosten', 'oxfam-webshop' ); ?></button></p>
