...
<ul class="woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
    ...
    <li class="empty">
        ...
        <span><?php esc_html_e( 'No products in the cart.', 'woocommerce' ); ?></span><br/><small><?php esc_html_e( 'Wil je een kortingsbon toevoegen? Voeg dan eerst enkele producten toe en klik op \'Bekijk winkeldmand\'.', 'oxfam-webshop' ); ?></small>
    </li>
