...
<ul class="woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
    ...
    <li class="empty">
        ...
        <span><?php esc_html_e( 'No products in the cart.', 'woocommerce' ); ?></span><br/><small><?php esc_html_e( 'Wil je een kortingsbon toevoegen? Voeg dan eerst enkele producten toe en klik op \'Winkelmand bekijken\'.', 'oxfam-webshop' ); ?></small>
    </li>
...
<div class="nm-cart-panel-summary">
    ...
    <div class="nm-cart-panel-summary-inner">
        ...
        <p class="woocommerce-mini-cart__total total">
            <strong><?php
                $empties_total = ob2c_get_total_empties_amount();
