<?php
	...
	// Lijst te gebruiken in script om post-ID's van oxfamwereldwinkels.be te vertalen naar node-ID's van oxfambelgie.be
	// Opgelet: komt zowel voor in 'oxfam_shop_node'-optie als in afhaalinstellingen (indien meerdere winkels per webshop)
	// Pas daarna kunnen we de API voor shopinfo switchen van de oude WordPress naar de nieuwe Drupal
	...
	// Wel oppassen als je een winkelpagina volledig zou wissen en opnieuw aanmaken, dan wijzigt de node-ID!
